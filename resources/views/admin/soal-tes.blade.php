                            ...
                            <tr>
                                ...
                                <td
                                    ...
                                    <div class="flex flex-col justify-center">
                                        <div
                                            class="py-1.5 bg-milkChoco text-white flex justify-center items-center rounded">
                                            <i class="fa-regular fa-note-sticky pe-2"></i>25 PG</div>
                                        <div
                                            class="py-1.5 bg-milkChoco text-white flex justify-center items-center rounded mt-1">
                                            <i class="fa-regular fa-note-sticky pe-2"></i>1 ESSY</div>
                                    </div>
                                </td>
                                <td
                                    class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                ...
                                <td
                                    class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                    <div
                                            class="py-1.5 bg-orange-500 text-white flex justify-center items-center rounded mt-1">
                                            <i class="fa-solid fa-calendar-days pe-2"></i>Rabu, 28 Februari 2024</div>
                                </td>
                                <td
                                    class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
